...
#        setting the trigger mode
        ...
        layout.addWidget(self.mainthings.w1, 0, 0)
        #layout.addWidget(QtGui.QPushButton("Button at (0, 1)"), 0, 1)
        #layout.addWidget(QtGui.QPushButton("Button at (0, 2)"), 0, 2)
        #layout.addWidget(QtGui.QPushButton("Button at (1, 0)"), 1, 0)
        #layout.addWidget(QtGui.QPushButton("Button at (1, 1)"), 1, 1)
        #layout.addWidget(QtGui.QPushButton("Button at (1, 2)"), 1, 2)
        #layout.addWidget(QtGui.QPushButton("Button at (2, 0)"), 2, 0)
        #layout.addWidget(QtGui.QPushButton("Button at (2, 1)"), 2, 1)
        #layout.addWidget(QtGui.QPushButton("Button at (2, 2)"), 2, 2)
