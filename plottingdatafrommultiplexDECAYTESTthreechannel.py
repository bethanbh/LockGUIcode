...
def plotdata(filename):
    ...
    return [np.array(decaytime), np.array(A0), np.array(A1), np.array(A2), np.array(time)]
...
testdata = plotdata(r'//homeblue02/mcwt12/My_Documents/phd yr1/STCL GUI/multiplextest/(11-10-2022-10h26)_channeldatadelaytest41.csv')
...
ax.scatter(testdata[0]/1000, testdata[3], label='A2')
ax.legend()
...
ax.scatter(placeholder, testdata[3], label='A2')
