...
data = plotdata(r'//homeblue02/mcwt12/My_Documents/phd yr1/STCL GUI/multiplextest/multiplexscopedata20.10.22/ALL0013/A0013CH1.csv')
data1 = plotdata(r'//homeblue02/mcwt12/My_Documents/phd yr1/STCL GUI/multiplextest/multiplexscopedata20.10.22/ALL0015/A0015CH4.csv')

data = data*2*10**-3 #from plottingscopedata.py yesterday - vertical scale/25
data1 = data1*2*10**-3
